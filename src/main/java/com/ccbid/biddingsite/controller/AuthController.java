...
/**
 * This is the controller for handling the auth and registering of users.
 * Important Methods:
 * Register: Creates a new user account 
 * Login: Logs in a user and returns a session token
 * Get Current User: Returns the current logged in user's information
 * Exception Handlers: Handles exceptions for bad credentials, bad requests, and conflicts (This was generated by Codex with the prompt "I'm recieving errors about handling a certain exception how do I approach this")
 */
